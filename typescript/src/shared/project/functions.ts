...
export async function readProject(apiRoot: ApiRoot, context: any, params: any): Promise<any> {
  try {
    const projectKey = params.projectKey;
    const requestBuilder = apiRoot.withProjectKey(projectKey || context.projectKey);
